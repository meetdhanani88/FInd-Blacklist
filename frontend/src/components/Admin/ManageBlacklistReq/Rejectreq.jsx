...
const Rejectreq = ({ openpop, handleClosepop, Listofuser, rejectVendorId }) => {
    ...
    return (
        <div>
            <Dialog open={openpop} onClose={handleClosepop} maxWidth="sm" scroll='paper' fullWidth

                aria-labelledby="scroll-dialog-title"
                aria-describedby="scroll-dialog-description"
            >
                <Box component="form" noValidate onSubmit={handleSubmit} >
                    <DialogTitle id="scroll-dialog-title">Reason For Rejection</DialogTitle>
                    ...
                    <DialogActions>
                        ...
                        <LoadingButton loading={mutation.isLoading} onClick={handelRejectvendor} disabled={!isValid || values.reason === ''}>Reject Request</LoadingButton>
                    </DialogActions>
                </Box>
